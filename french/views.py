...
from .models import TmonthFr as Tmonth
from .models import ThoughtFr as Thought
...
def newsfactory(request, year_month):
    ...
    return render(request, 'fr/newsfactory.html', context)
...
def thought(request, yy_mm_dd):
    ...
    return render(request, 'fr/thought.html', context)
...
def search(request):
    ...
    return render(request, 'fr/search_result.html', context)
...
def contributors(request):
    ...
    return render(request, 'fr/contributors.html', context)
